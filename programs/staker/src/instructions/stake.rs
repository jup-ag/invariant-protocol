...
pub fn handler(ctx: Context<CreateUserStake>) -> Result<()> {
    ...
    require!(Seconds::now() >= { incentive.start_time }, crate::ErrorCode::NotStarted);
    require!(Seconds::now() < { incentive.end_time }, crate::ErrorCode::Ended);
    require!(incentive.num_of_stakes < u64::MAX, crate::ErrorCode::NoStakes);
    ...
    **user_stake = UserStake {
    ...
    require!(!liquidity.is_zero(), crate::ErrorCode::ZeroLiquidity);
    Ok(())
}
